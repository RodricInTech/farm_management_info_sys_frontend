...
export default function FertilizerRecords() {
  const records = [
    { id: 1, cropName: "Wheat", fertilizerType: "NPK (20-20-20)", quantity: "500 kg", applicationDate: "2026-05-15", cost: "$250" },
    { id: 2, cropName: "Corn", fertilizerType: "Urea", quantity: "300 kg", applicationDate: "2026-05-18", cost: "$120" },
    { id: 3, cropName: "Rice", fertilizerType: "DAP", quantity: "250 kg", applicationDate: "2026-05-20", cost: "$100" },
    { id: 4, cropName: "Soybeans", fertilizerType: "Organic Manure", quantity: "1000 kg", applicationDate: "2026-05-22", cost: "$180" },
  ];
    ...
    <main className="flex-1 p-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <StatCard title="Total Cost" value="$650" change="Current period" />
        </div>
