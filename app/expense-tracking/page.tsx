...
export default function ExpenseTracking() {
    ...
    const expenseByCategory = [
        { category: "Fertilizers", amount: "MK450", percentage: 25 },
        { category: "Labor", amount: "MK640", percentage: 35 },
        { category: "Seeds", amount: "MK180", percentage: 10 },
        { category: "Equipment", amount: "MK250", percentage: 14 },
        { category: "Pesticides", amount: "MK150", percentage: 8 },
        { category: "Utilities", amount: "MK150", percentage: 8 },
    ];
